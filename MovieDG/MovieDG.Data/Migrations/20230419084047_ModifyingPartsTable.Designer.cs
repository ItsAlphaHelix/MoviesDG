...
namespace MoviesDG.Data.Migrations
{
    ...
    [Migration("20230419084047_ModifyingPartsTable")]
    partial class ModifyingPartsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieDG.Data.Data.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieDG.Data.Data.Models.MoviePart", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MovieId", "PartId");

                    b.HasIndex("PartId");

                    b.ToTable("MoviesParts");
                });

            modelBuilder.Entity("MovieDG.Data.Data.Models.Part", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieDG.Data.Data.Models.MoviePart", b =>
                {
                    b.HasOne("MoviesDG.Data.Models.Movie", "Movie")
                        .WithMany("MoviesParts")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieDG.Data.Data.Models.Part", "Part")
                        .WithMany()
            ...
            modelBuilder.Entity("MoviesDG.Data.Models.Movie", b =>
                {
                    b.HasOne("MovieDG.Data.Data.Models.Part", null)
                        .WithMany("Movies")
                        .HasForeignKey("PartId");
                });
