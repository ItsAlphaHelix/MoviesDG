namespace MovieDG.Web.Areas.Administration.AdminMessageConstants
{
    public static class MessageConstants
    {
        ...
        public const string SuccessDeleteQuestion = "Successfully deleted question!";

        public const string MovieStartIndexErrorMessage = "End index cannot be less than Start index.";
